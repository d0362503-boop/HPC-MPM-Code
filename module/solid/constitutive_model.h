...
class ConstitutiveModel {
  public:
     ...
     * @param model_type Constitutive model ID (-1 rigid, 0 linear elastic, 1 Neo-Hookean, 2 St. Venant-Kirchhoff, 3
     * Mooney-Rivlin).
     ...
     */
    void MatLinElast(std::array<double, 6> &stress, const std::array<std::array<double, 3>, 3> &delta_def_grad,
     ...
     * @param jac_bar  F-bar corrected determinant.
     */
    void MatNeoHookean(std::array<double, 6> &stress, const std::array<std::array<double, 3>, 3> &FF,
     ...
     * @param jac      Determinant of `FF`.
     */
    void MatStVk(std::array<double, 6> &stress, const std::array<std::array<double, 3>, 3> &FF,
     ...
     * @param jac_bar  F-bar corrected determinant.
     */
    void MatMooneyRivlin(std::array<double, 6> &stress, const std::array<std::array<double, 3>, 3> &FF,
                         const std::vector<double> &mat_prop, double jac, double jac_bar);
};
